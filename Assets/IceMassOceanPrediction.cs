...
public class IceMassOceanPrediction : MonoBehaviour {
	...
	private static IceMassOceanPrediction instance;

	public static IceMassOceanPrediction Instance
	{
		get{ 
			return instance;
		}
	...
	void Start () {
		...
		int i = 0;
		StreamReader sr= new StreamReader("IceDataOcean.txt");
		while (sr.Peek ()>=0) {
	...
	public float getIcePredictionOcean(float y,float m, float d){
		float yearDecimal;
		int i;
