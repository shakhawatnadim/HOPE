...
public class IceMassGreenlandPrediction : MonoBehaviour {
	...
	private static IceMassGreenlandPrediction instance;

	public static IceMassGreenlandPrediction Instance
	{
		get{ 
			return instance;
		}
	...
	public float getIcePredictionGreenland(float y,float m, float d){
		float yearDecimal;
		int i;
		...
		if (yearDecimal < 2002)
			return 0;
		return yVal[0]-( yintercept + (slope * yearDecimal));
	}
